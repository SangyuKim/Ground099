 ...
 */
public class CustomDateSlider extends Dialog {
...
//	private static String TAG = "DATESLIDER";
    ...
    public CustomDateSlider(Context context, int layoutID, OnDateSetListener l, Calendar initialTime) {
    	this(context,layoutID,l,initialTime, null, null, 1);
    }

    public CustomDateSlider(Context context, int layoutID, OnDateSetListener l, Calendar initialTime, int minInterval) {
    	this(context,layoutID,l,initialTime, null, null, minInterval);
    }

    public CustomDateSlider(Context context, int layoutID, OnDateSetListener l,
    ...
    private View.OnClickListener okButtonClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            if (onDateSetListener!=null)
                onDateSetListener.onDateSet(CustomDateSlider.this, getTime());
            dismiss();
        }
    };
    ...
    public interface OnDateSetListener {
         ...
         *
         */
        public void onDateSet(CustomDateSlider view, Calendar selectedDate);
    }
}
