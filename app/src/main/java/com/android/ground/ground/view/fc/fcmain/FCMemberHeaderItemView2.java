...
public class FCMemberHeaderItemView2 extends FrameLayout {
    ...
    public void init(){
        ...
        btnManagement = (Button)findViewById(R.id.button24);
    }

    public Button getBtnManagement() {
        return btnManagement;
    }

    public void setBtnManagement(Button btnManagement) {
        this.btnManagement = btnManagement;
    }
}
