...
public class FCManagemnetTabsAdapter extends FragmentPagerAdapter implements
	...
	public FCManagemnetTabsAdapter(FragmentActivity activity, TabHost tabHost,
								   ViewPager pager) {
			this(activity, activity.getSupportFragmentManager(), tabHost, pager);
	}

	public FCManagemnetTabsAdapter(Context context, FragmentManager fragmentManager, TabHost tabHost, ViewPager pager) {
