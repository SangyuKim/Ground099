...
public class BezierEndpoints {
    ...
    private CustomCircleTangents tangents;
    ...
    private BezierEndpoints(boolean top) {
        ...
        this.tangents = new CustomCircleTangents();
        this.pts = new PointF[]{new PointF(), new PointF(), new PointF(), new PointF()};
        this.top = top;
    }

    public void evaluateBezierEndpoints(CustomCircle c1, CustomCircle c2, BezierQ bezierQ) {
