 ...
 */
public abstract class CustomShaderImageView extends ImageView {


    private final static boolean DEBUG = false;
    private CustomShaderHelp pathHelper;

    public CustomShaderImageView(Context context) {
        super(context);
        setup(context, null, 0);
    }

    public CustomShaderImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup(context, attrs, 0);
    }

    public CustomShaderImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected CustomShaderHelp getPathHelper() {
        if(pathHelper == null) {
    ...
    protected abstract CustomShaderHelp createImageViewHelper();
