 ...
 */
public class CustomRubberLoaderView  extends View {
    ...
    private CustomCoordinator coors;

    public CustomRubberLoaderView(Context context) {
        super(context);
        extractAttrs(null);
        preparePaint();
        prepareMetrics();
    ...
    public CustomRubberLoaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        extractAttrs(attrs);
        preparePaint();
        prepareMetrics();
    ...
    private void extractAttrs(AttributeSet attrs) {
        TypedArray a = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.CustomRubberLoaderView, 0, 0);
        try {
            primeColor = a.getColor(R.styleable.CustomRubberLoaderView_loaderPrimeColor, Color.BLACK);
            extraColor = a.getColor(R.styleable.CustomRubberLoaderView_loaderExtraColor, Color.GRAY);
            rippleColor = a.getColor(R.styleable.CustomRubberLoaderView_loaderRippleColor, Color.WHITE);

            size = a.getInt(R.styleable.CustomRubberLoaderView_loaderSize, SMALL);
            ripple = a.getInt(R.styleable.CustomRubberLoaderView_loaderRippleMode, RIPPLE_NONE);
            mode = a.getInt(R.styleable.CustomRubberLoaderView_loaderMode, MODE_NORMAL);
        } finally {
            a.recycle();
        }
    }
    ...
    private void preparePaint() {
        ...
        coors = new CustomCoordinator(this);
    }
