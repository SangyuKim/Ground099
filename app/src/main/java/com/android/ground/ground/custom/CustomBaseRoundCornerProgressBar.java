 ...
 */
public abstract class CustomBaseRoundCornerProgressBar extends LinearLayout {
    ...
    public CustomBaseRoundCornerProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (isInEditMode()) {
    ...
    public CustomBaseRoundCornerProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
