...
public class SearchFCTestItemView extends RelativeLayout {
    public SearchFCTestItemView(Context context) {
        super(context);
        init();
    }

    public SearchFCTestItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                   if (mRequestListener != null) {
                    mRequestListener.onRequestButtonClick(SearchFCTestItemView.this, mItem);
                }
            }
        });
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mMatchListener != null) {
                    mMatchListener.onMatchtButtonClick(SearchFCTestItemView.this, mItem);
                }
            }
        });
...
//                .displayer(new RoundedBitmapDisplayer(50))
    ...
    OnMatchButtonClickListener mMatchListener;
    public void setOnMatchtButtonListener(OnMatchButtonClickListener listener) {
